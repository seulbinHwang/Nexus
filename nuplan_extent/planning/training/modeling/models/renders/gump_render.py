...
class GUMPRender(nn.Module):
    ...
    def update_last_frame_data(self, last_tokenized_arrays, pred_agent_tokens, return_list=None) -> Dict:
        """
        Dummy forward
        """
        return gutils.update_last_frame_data(last_tokenized_arrays, pred_agent_tokens, return_list)
