...
class DiffusionForcingBase(BasePytorchAlgo):
    def __init__(
        ...
        self.cfg = {}
        self.cfg['frame_skip'] = 1
        self.cfg['diffusion'] = {}
        self.cfg['diffusion']['cum_snr_decay'] = 0.98
        self.cfg['diffusion']['cum_snr_decay'] = self.cfg['diffusion']['cum_snr_decay'] ** (self.frame_stack * self.cfg['frame_skip'])
